...
Para descargarlo, podemos acudir a la [página de descarga de Tor Browser](https://www.torproject.org/download/languages/), buscar la tabla y elegir el instalador de la plataforma que corresponda. En este caso, para Windows de 64 bits, dejo el [enlace a la versión 15.0.11](https://dist.torproject.org/torbrowser/15.0.11/tor-browser-windows-x86_64-portable-15.0.11.exe), la actual mientras escribo esta guía. No uses este enlace si hay una versión posterior. Como veremos más adelante, mantenerse actualizado en este terreno no es opcional, sino una precaución más. Si quieres actualizar el navegador, conéctalo a la red TOR, ve al menú Ayuda y elige la opción Acerca de, tal y como harías con Firefox.
